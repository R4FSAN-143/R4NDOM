...
1;93m×××××××××××××××××\033[1;93m××××××××××××××\033[1;93m××××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mRAFSAN AHAMMED RAFI   \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m RAFSAN                \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mR4FSAN-143               \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning Bd     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35TIGER SQUAD                   \033[1;93m|
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/saifulis11=ZbWKwL');time.sleep(1)
		admin()
	if bal =='2':
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write(f" \r{R} [{B} R4FSAN{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
